...
func (d *decoder) validate() os.Error {
    if d.crc32 > 0 {
...
func (d *decoder) readHeader() (err os.Error) {
    var s string
...
func (d *decoder) readPartHeader() (err os.Error) {
    var s string
    // find the start of the header
    for {
        s, err = d.buf.ReadString('\n')
...
func (d *decoder) parseTrailer(line string) os.Error {
    // split on space for headers
...
func (d *decoder) readBody() os.Error {
    // ready the part body 
